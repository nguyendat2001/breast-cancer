...
def train_val(args , save_dir):
    ...
    val_generator = aug.flow_from_directory(directory=args.val,
                                                    target_size=(args.im_size, args.im_size),
                                                    # classes=['NORMAL','PNEUMONIA','TURBERCULOSIS'],
                                                    # color_mode="grayscale",
                                                    subset = "validation",
...
#                                                   patience=15)
    ...
    loss_test,accuracy_test,auc_test ,f1_test,precision_test, recall_test = model.evaluate(val_generator)
